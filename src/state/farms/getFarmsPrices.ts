...
const getFarmBaseTokenPrice = (
  ...
  // We can only calculate profits without a quoteTokenFarm for BUSD/EVT farms
  if (!quoteTokenFarm) {
    return BIG_ZERO
  }
  ...
  // i.e. for farm PNT - pBTC we use the pBTC farm's quote token - EVT, (pBTC - EVT)
  // from the EVT - pBTC price, we can calculate the PNT - BUSD price
