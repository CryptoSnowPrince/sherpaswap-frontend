...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and YAK pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and YAK pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from YAK pool', data)
  }
